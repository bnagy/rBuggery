  ...
  class DebugRegisters2
    ...
    def initialize( parent )
      ...
      @api_dispatch_table={
        ...
        :GetStackOffset=>FFI::Function.new( :ulong, [:pointer,:pointer], @vtable[12], :convention=>:stdcall  ),
        :GetFrameOffset=>FFI::Function.new( :ulong, [:pointer,:pointer], @vtable[13], :convention=>:stdcall  ),
        :GetDescriptionWide=>FFI::Function.new( :ulong, [:pointer,:ulong,:pointer,:ulong,:pointer,:pointer], @vtable[14], :convention=>:stdcall  ),
        :GetIndexByNameWide=>FFI::Function.new( :ulong, [:pointer,:string,:pointer], @vtable[15], :convention=>:stdcall  ),
        :GetNumberPseudoRegisters=>FFI::Function.new( :ulong, [:pointer,:pointer], @vtable[16], :convention=>:stdcall  ),
        :GetPseudoDescription=>FFI::Function.new( :ulong, [:pointer,:ulong,:pointer,:ulong,:pointer,:pointer,:pointer], @vtable[17], :convention=>:stdcall  ),
        :GetPseudoDescriptionWide=>FFI::Function.new( :ulong, [:pointer,:ulong,:pointer,:ulong,:pointer,:pointer,:pointer], @vtable[18], :convention=>:stdcall  ),
        :GetPseudoIndexByName=>FFI::Function.new( :ulong, [:pointer,:string,:pointer], @vtable[19], :convention=>:stdcall  ),
        :GetPseudoIndexByNameWide=>FFI::Function.new( :ulong, [:pointer,:string,:pointer], @vtable[20], :convention=>:stdcall  ),
        :GetPseudoValues=>FFI::Function.new( :ulong, [:pointer,:ulong,:ulong,:pointer,:ulong,:pointer], @vtable[21], :convention=>:stdcall  ),
        :SetPseudoValues=>FFI::Function.new( :ulong, [:pointer,:ulong,:ulong,:pointer,:ulong,:pointer], @vtable[22], :convention=>:stdcall  ),
        :GetValues2=>FFI::Function.new( :ulong, [:pointer,:ulong,:ulong,:pointer,:ulong,:pointer], @vtable[23], :convention=>:stdcall  ),
        :SetValues2=>FFI::Function.new( :ulong, [:pointer,:ulong,:ulong,:pointer,:ulong,:pointer], @vtable[24], :convention=>:stdcall  ),
        :OutputRegisters2=>FFI::Function.new( :ulong, [:pointer,:ulong,:ulong,:ulong], @vtable[25], :convention=>:stdcall  ),
        :GetInstructionOffset2=>FFI::Function.new( :ulong, [:pointer,:ulong,:pointer], @vtable[26], :convention=>:stdcall  ),
        :GetStackOffset2=>FFI::Function.new( :ulong, [:pointer,:ulong,:pointer], @vtable[27], :convention=>:stdcall  ),
        :GetFrameOffset2=>FFI::Function.new( :ulong, [:pointer,:ulong,:pointer], @vtable[28], :convention=>:stdcall  ),
      }
    end
